...
class DistributedScion(torch.optim.Optimizer):
    ...
    def step(self, closure=None):
        ...
        self.need_to_calculate_norm = False
        self.step_embedding(
            embed_params, embed_param_names, need_to_calculate_norm=need_to_calculate_norm
        )
        self.step_experts(
            expert_params, expert_param_names, need_to_calculate_norm=need_to_calculate_norm
        )
        self.step_ddp(ddp_params, ddp_param_names, need_to_calculate_norm=need_to_calculate_norm)
        self.step_fsdp(fsdp_params, fsdp_param_names, need_to_calculate_norm=need_to_calculate_norm)
